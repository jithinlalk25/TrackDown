...
public class Level7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.location, container,
                false);
        ...
        DatabaseReference myRef_a = database.getReference("Questions").child("l7").child("a");
        ...
        location.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://goo.gl/maps/QXFt4kTxeGv"));
        ...
        go.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(s.equals(A) && s.length() > 3){
                    ...
                    /*if(currenttime()){
                        ((MainActivity) getActivity()).SelectLevel(8);
                    }else{
    ...
    public boolean currenttime(){
        ...
        try {
            ...
            P.SetTime(getActivity(),7,Current);

            //Toast.makeText(getApplicationContext(),""+Current, Toast.LENGTH_LONG).show();


            long time = Current-P.GetTime(getActivity(),6);
            ...
            DatabaseReference participant_myRef = database.getReference("Participants").child(P.Participant_No).child("Game").child("Level 07");
    ...
    private class upload extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (currenttime()) {
                ...
                a=1;
                ((MainActivity) getActivity()).SelectLevel(8493);
            } else {
                a=0;
                //Toast.makeText(getActivity(), "Network Error!", Toast.LENGTH_SHORT).show();
            }
