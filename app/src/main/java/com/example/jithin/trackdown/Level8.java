...
public class Level8 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.audio, container,
                false);
        ...
        DatabaseReference myRef_a = database.getReference("Questions").child("l8").child("a");
        ...
        audio=(ImageView) rootView.findViewById(R.id.audio);

        audio.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://trackdownlistening.000webhostapp.com/"));
        ...
        go.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(s.equals(A) && s.length() > 3){
                    ...
                    /*if(currenttime()){
                        ((MainActivity) getActivity()).SelectLevel(9);
                    }else{
    ...
    public boolean currenttime(){
        ...
        try {
            ...
            P.SetTime(getActivity(),8,Current);

            //Toast.makeText(getApplicationContext(),""+Current, Toast.LENGTH_LONG).show();


            long time = Current-P.GetTime(getActivity(),7);
            ...
            DatabaseReference participant_myRef = database.getReference("Participants").child(P.Participant_No).child("Game").child("Level 08");
    ...
    private class upload extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (currenttime()) {
                ...
                a=1;
                ((MainActivity) getActivity()).SelectLevel(9192);
            } else {
                a=0;
                //Toast.makeText(getActivity(), "Network Error!", Toast.LENGTH_SHORT).show();
            }
