...
public class Level6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.oreo, container,
                false);
        ...
        DatabaseReference myRef_a = database.getReference("Questions").child("l6").child("a");
        ...
        oreo=(ImageView) rootView.findViewById(R.id.oreo);

        oreo.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://drive.google.com/open?id=0B4I83_PxiYGVV2dvOTUwZVRxUlk"));
                startActivity(browserIntent);
            }
        });

        go = (FloatingActionButton)rootView.findViewById(R.id.fab);
        no = (EditText)rootView.findViewById(R.id.no);
        ...
        go.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(s.equals(A) && s.length() > 3){
                    ...
                    /*if(currenttime()){
                        ((MainActivity) getActivity()).SelectLevel(7);
                    }else{
    ...
    public boolean currenttime(){
        ...
        try {
            ...
            P.SetTime(getActivity(),6,Current);

            //Toast.makeText(getApplicationContext(),""+Current, Toast.LENGTH_LONG).show();


            long time = Current-P.GetTime(getActivity(),5);
            ...
            DatabaseReference participant_myRef = database.getReference("Participants").child(P.Participant_No).child("Game").child("Level 06");
    ...
    private class upload extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (currenttime()) {
                ...
                a=1;
                ((MainActivity) getActivity()).SelectLevel(7678);
            } else {
                a=0;
                //Toast.makeText(getActivity(), "Network Error!", Toast.LENGTH_SHORT).show();
            }
